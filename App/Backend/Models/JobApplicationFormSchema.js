/**
 * This file contains the schema for job application form file.
 * 
...
const jobApplicationFormSchema = mongoose.Schema({
    ...
    jobApplicationForm:{ type: String, default: null, required: true}, 
}, { timestamps: true, _id: false});

jobApplicationFormSchema.plugin(uniqueValidator);
